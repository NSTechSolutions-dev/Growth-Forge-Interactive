  ...
  head: () => ({
    meta: [
      ...
      { title: "My Lead Foundry — Performance Marketing Agency" },
      {
        name: "description",
        content:
          "Data-driven ad systems across Google Ads, WhatsApp, SMS, email and programmatic channels.",
      },
      { name: "author", content: "My Lead Foundry" },
      { property: "og:site_name", content: "My Lead Foundry" },
